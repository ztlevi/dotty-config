...
# if encounter Permission denied, /dev/pts/3, try `unset SSH_TTY`, kill ssh in client machine
# or ssc restart sshd in remote machine. https://github.com/spudlyo/clipetty/issues/20
alias et="emacs -nw"
